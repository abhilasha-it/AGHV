"""Oxford 102 Flowers category-id -> common/scientific name mapping.

This is the community-standard `cat_to_name` mapping widely used with this
dataset (torchvision.datasets.Flowers102 labels are 0-indexed; add 1 to get
the ids used here). Family names are approximate and only used for display
in the controller UI's result card -- double check against a botanical
reference before using them in a publication.
"""
...
CAT_TO_NAME = {
    ...
    77: "passion flower", 78: "lotus", 79: "toad lily", 80: "anthurium",
...
def label_to_name(label_0_indexed: int) -> str:
    """torchvision Flowers102 labels are 0-indexed; CAT_TO_NAME is 1-indexed."""
    return CAT_TO_NAME.get(label_0_indexed + 1, f"class_{label_0_indexed}")
